...
/**
 *         Description : Node class to process the information about the nodes. This class contains getter and setter methods to access and set information about the nodes.
 *         The information generally includes the list of adjacent nodes, distance from the source, color of the node and the parent/predecessor node.
 *          
...
public class Node {
	...
	// constructor: the parameter nodeInfo  is the line that is passed from the input, this nodeInfo is then split into key, value pair 
	//where the key is the node id and the value is the information associated with the node
	public Node(String nodeInfo) {
		String key = "";
		String value = ""; //initializing the strings 'key' and 'value'
	...
	public Text getNodeInfo() {
		...
		// append the minimum distance between the current distance and Integer.Max_VALUE

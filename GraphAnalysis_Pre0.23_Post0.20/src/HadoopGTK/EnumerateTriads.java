...
public class EnumerateTriads extends ExampleBaseJob {
	...
	public static class AugmentDegreeMapper extends Mapper<Object, Text, Text, Text> {
	...
	public static class AugmentDegreeReducer extends Reducer<Text, Text, Text, Text> {
